...
date: '2018-03-21'
lastmod: '2018-04-28T13:46:55-04:00'
slug: essentials-of-data-science
tags: [Data Science, R]
description: There is a lot of information on Data Science on Internet. On this page I summarize the most essential things you would need to know to start working on real projects. The rest you can figure out on the way. This page is intentionally short (relativelly).
---
...
### Tools, Installation and updating

* installr package 
    * for updating R to a newer version (from RGui do installr::updateR())
    * installing Rtools, git, ImageMagick, etc. [Link](https://cran.r-project.org/web/packages/installr/installr.pdf)

* devtools package for installation of packages from github repositories directly	
	
### Interactive dashboards

* [R Shiny](https://shiny.rstudio.com/)
* [R Shiny Gallery](https://shiny.rstudio.com/gallery/)
* [R Shiny themes](https://rstudio.github.io/shinythemes/)
...
* [Visualize Large Data](http://spark.rstudio.com/taxiDemoH2O.nb.html#visualize) 
* [color palletes in R](https://github.com/EmilHvitfeldt/r-color-palettes)

### Books with Rmarkdown

* https://bookdown.org/yihui/bookdown/

### Websites with Rmarkdown

Static sites (no need of databases, use of wordpress, etc.). Host for free on GitHub pages
...
* themes for hugo (a static site generator used by blogdown package) 
    * find the one you like on this site https://themes.gohugo.io/
    * press Download - it should open a github address (if it is not GitHub it is ok..)
    * use this to install blogdown::install_theme("user/repo"). It it is not on GitHub speicify hostname
    * fine tune the theme
    * host on GitHub pages or better in [netfly](https://www.netlify.com/github-pages-vs-netlify/) 
